                ...
                <div id="top-menu__nav">
                    <ul>
                        <li class="top-menu__itm"><a href="tel:80291233300"><i class="fa fa-phone"
                                    aria-hidden="true"></i>&nbsp;+375 29 12-33-300</a></li>
                        <li class="top-menu__itm"><a href="/contacts/"><i class="fa fa-map-marker"
                                    aria-hidden="true"></i>&nbsp;г.Могилев, ул. Комсомольская, 10</a></li>
            ...
            <div class="header-wrap">
                <nav class="active">
                    ...
                    <ul>
                        ...
                        <li class="header__itm" id="admin_panel"><a href="javascript:openSubMenu()"  class="btn" >Панель администратора
    ...
    <footer>
        <div class="header-wrap">
            <div class="footer__log">
                <a class="login" href="/login" target="_blank"><i class="fa fa-sign-in"
