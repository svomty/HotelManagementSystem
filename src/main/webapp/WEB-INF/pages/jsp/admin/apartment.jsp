                    ...
                    <div class="divTableHeading">
                        <div class="divTableRow">
                            ...
                            <div class="divTableCell">
                                ...
                                <a id="number"
                                   href="${pageContext.request.contextPath}?page=1&sort=number&size=${size}&type=${type}&place=${place}&room=${room}">
                                    Номер апартамента</a>
                            ...
                            <div class="divTableCell">
                                ...
                                <a id="price"
                                   href="${pageContext.request.contextPath}?page=1&sort=price&size=${size}&type=${type}&place=${place}&room=${room}">
                                    Стоимость места</a>
                            ...
                            <div class="divTableCell">
                                ...
                                <a id="rooms_number"
                                   href="${pageContext.request.contextPath}?page=1&sort=rooms_number&size=${size}&type=${type}&place=${place}&room=${room}">
                                    Кол-во комнат</a>
                            ...
                            <div class="divTableCell">
                                ...
                                <a id="places_number"
                                   href="${pageContext.request.contextPath}?page=1&sort=places_number&size=${size}&type=${type}&place=${place}&room=${room}">
                                    Кол-во мест</a>
                            ...
                            <div class="divTableCell">
                                ...
                                <a id="type"
                                   href="${pageContext.request.contextPath}?page=1&sort=type&size=${size}&type=${type}&place=${place}&room=${room}">
                                    Тип номера</a>
                            ...
                            <div class="divTableCell">
                                ...
                                <a id="description"
                                   href="${pageContext.request.contextPath}?page=1&sort=description&size=${size}&type=${type}&place=${place}&room=${room}">
                                    Описание</a>
                        ...
                        <div class="divTableBody">
                            <div class="divTableRow">
                                ...
                                <div class="divTableCell">
                                    ...
                                    <spring:url
                                            value="${urlBase}${urlReturn}delete/${apartments.id }?page=${current_page}&size=${size}&sort=${sort}&type=${type}&place=${place}&room=${room}"
                                            var="deleteURL"/>
