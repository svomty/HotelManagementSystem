...
<head>
    ...
    <title>Отчет о проживании в гостинице</title>
    ...
    <c:url var="urlReturn" value="/admin/reports/stay_report"/>
...
<div class="content">
    ...
    <main>
        ...
        <div class="header-wrap">
            <div>
                <h1>Отчет о проживании в гостинице</h1>
...
<script>
    popup_active("/admin/reports/stay_report");
</script>
</body>
